...
| <span id="meeting-4"></span><span id="session-4">S4</span> | 2026-09-09 | Wed | Predict and verify H-bridge PWM and direction waveforms before applying TEC power. | [Module 2](lab-02/index.md) | [**C1**](../assessment.md#c1-development-environment-and-repository) demonstrated during class; each student submits the text response by 5:00 PM; `Prep`: H-bridge prediction table | G1, G2, G5, G6 |
