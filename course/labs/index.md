...
| <span id="meeting-3"></span><span id="session-3">S3</span> | 2026-09-02 | Wed | Build a thermistor divider; convert ADC readings to resistance and temperature; state calibration assumptions. | [Module 2: First Real Instrument Pieces](lab-02/index.md) | [**A1**](lab-01/index.md#a1-module-1-evidence-note) due 9:05 AM; [**C1**](../assessment.md#c1-development-environment-and-repository) demonstrated during class, receipt by 11:55 AM | G1-G4, G12, G14 |
