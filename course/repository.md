...
This website and the student course materials come from the same GitHub
repository. Assignments are Markdown files, so they can be read:

- as rendered pages on this website,
- directly on GitHub,
